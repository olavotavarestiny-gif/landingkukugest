...
const HERO_BULLETS = [
  'CRM e processos de venda',
  'Tarefas e equipa organizadas',
  'Finanças e vendas num só lugar',
  '14 dias grátis, sem cartão',
];

export default function LandingHero({ primaryCtaHref }: { primaryCtaHref: string }) {
  return (
      ...
      <div className="relative">
        ...
        <div className="mx-auto grid min-h-[calc(100svh-84px)] max-w-7xl items-center gap-12 px-4 pb-16 pt-10 md:px-6 lg:grid-cols-[minmax(0,520px)_1fr] lg:gap-16 lg:pb-24 lg:pt-8">
          <div className="max-w-[34rem]">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.08] px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-white/75 backdrop-blur-sm">
              Gestão simples para empresas que querem crescer
            </div>

            <h1 className="mt-5 text-balance text-4xl leading-[0.94] tracking-[-0.05em] text-white md:text-6xl lg:text-[4.6rem]">
              <span className="block font-light text-white/88">Organiza clientes,</span>
              <span className="block font-black">vendas e equipa.</span>
              <span className="block font-medium text-white/92">Cresce com mais controlo.</span>
            </h1>

            <p className="mt-6 max-w-[34rem] text-base font-light leading-7 text-white/78 md:text-lg">
              Centraliza contactos, processos de venda, tarefas, finanças e equipa numa plataforma simples, criada para empresas angolanas que querem crescer com método.
            </p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button
                ...
                rel="noopener noreferrer"
                size="lg"
                className="min-w-[220px] justify-center gap-2 rounded-[20px] border border-[#ffb477]/30 bg-[#F06A1A] text-white shadow-[0_26px_62px_-26px_rgba(240,106,26,0.9)] hover:bg-[#db5f16]"
              >
                Começar grátis
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="min-w-[220px] rounded-[20px] border border-white/16 bg-white/[0.08] font-medium text-white backdrop-blur-md hover:border-white/40 hover:bg-white hover:text-[#0A2540]"
              >
                Ver funcionalidades
              </Button>
            </div>
            ...
            <div className="relative mx-auto aspect-[1.24/1] w-full max-w-4xl">
              ...
              <div className="absolute left-0 top-0 w-[88%] overflow-hidden rounded-[28px] border border-white/15 bg-white/95 p-3 shadow-[0_40px_120px_-50px_rgba(0,0,0,0.75)] backdrop-blur-md md:p-4">
                <Image
                  ...
                  alt="Painel KukuGest para empresas de serviços com CRM, receita e gestão comercial."
                  width={2940}
                  height={1606}
                  priority
              ...
              <div className="absolute bottom-0 right-0 w-[64%] overflow-hidden rounded-[26px] border border-white/15 bg-white/96 p-3 shadow-[0_40px_120px_-52px_rgba(0,0,0,0.75)] backdrop-blur-md md:p-4">
                <Image
                  ...
                  alt="Painel KukuGest para comércio com vendas diárias, caixa e operação."
                  width={2940}
                  height={1602}
                  priority
